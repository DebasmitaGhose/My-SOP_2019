...
\par
I find my research interests closely being done in the domain of robotic manipulation by Micheal Posa's group at the Dynamic Autonomy and Intelligent Robotics Lab. I liked their work "A Quasi-static Model and Simulation Approach for Pushing, Grasping, and Jamming", where they model manipulator feedback to generate physically grounded motion, even if the velocity commands given to it are not feasible. It will be exciting to extend this model to three-dimensional motion, like grasping and walking, which could subsequently counteract the effects for gravitational load. Therefore, I strongly believe that the GRASP Lab at the University of Pennsylvenia would be the right place for me to explore the intersection of Robotics and Brain Computer Interface, which I would like to emphasise on for my doctoral research. 
\par
