...
\large of \yourname\ (PhD applicant for Fall-2019 - Yale)
\end{center}
...
\par
 ...
 \par
I find my research interests closely aligned with Brian Scassellati at the Social Robotics Lab. I enjoyed reading his paper "Toward Human-Like Robot Learning", where he works on teaching robots to perform certain tasks using natural language instructions. I believe that this work takes a big step towards making human-robot collaboration easier. I also like some of his work where he uses robots as tutors to specially-abled children. 
\par
I also like the work being done by Marynel V{\`a}zquez in the area of human robot interaction. I learnt about her work and some of her plans for her future course of research when I had a chance to meet her when she visited UMass Amherst. I enjoyed watching videos of her experiments with the furniture robot and children, during her time at Disney. I believe her experiments convey valuable insights about the behaviour of children around robots and how robots should behave around children to engage them in a meaningful activity. I liked her paper "Go-Net - A Semi-Supervised Deep Learning Approach For Traversability Estimation", where she used GANs to predict if the path to be traversed by the robot is safe or not. I find this idea particularly interesting because it is very dangerous to collect negative samples of the robot trying to traverse paths which are not traversible. 
\par
Therefore, I strongly believe that Yale University would be the right place for me to explore my interests in the area of human-robot interaction, and I would like to emphasise on the same for my doctoral research. 
