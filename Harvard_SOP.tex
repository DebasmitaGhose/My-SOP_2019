...
\large of \yourname\ (PhD applicant for Fall-2019 - Harvard)
\end{center}
...
\par
I find my research interests closely aligned with the work being done at Scott Kuindersma's group at the Harvard Agile Robotics Lab. The best thing I like about their lab is that they work on optimizing control systems on different types of complex physical systems, ranging from bipeds to MAVs to exoskeletons. In particular, I liked his recent paper, "Variational Contact-Implicit Trajectory Optimization", where he worked on building contact force trajectory optimization algorithms, that work for discontinuities in frictional contact with the environment. I have also followed some of his earlier work on reinforcement learning and optimal control on the uBot and the Atlas robots. I find his work consistent with my long term goal of designing optimal control systems for legged robots, to enable them to operate seemlessly in difficult terrain. Therefore, I strongly believe that Harvard University would be the right place for me to work on optimal control of legged robots and I would like to emphasise on for my doctoral research. 
