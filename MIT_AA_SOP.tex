...
\large of \yourname\ (PhD applicant for Fall-2019 - MIT AA)
\end{center}
...
\par
I find my research interests closely aligned with the work being done by Julie Shah's group at the Interactive Robotics Lab. I like her approach to human-robot teaming in industrial settings, where humans and robots learn from each other, to improve the performance of the team. For this to work seemlessly, humans and robots should be capable of assessing each others actions and predict each others future actions. In this regard, I enjoyed reading her article "Introducing Mobile Robots to
Moving-Floor Assembly Lines". I liked the fact that they introduced robots in factories where conveyer belts are used to transporting material within the factory, and designed a controller to compensate for the robots position while it crosses the conveyor belt. So, for a robot to work in such a dynamically changing setting, robots should be able to predict the change in its environment and the actions of humans around it, to make a decision about where its services would be needed and schedule its next task based on onstraints in the environment. 
\par 
I have also had the opportunity to interact with the Post Doctorate Fellow, from this lab, when I learnt about some of the other research questions the lab is working on. He spoke about his work, "Toward a Real-time Activity Segmentation Method for Human-Robot Teaming", where a robot could deduce the next action of the human it is assisting by looking at its initial trajectory, which I believe, takes a sizeable step towards building cooperative human-robot teams and is consistent with my long term goal of enabling cooperative teamwork between humans and robots. Therefore, I believe that Massachusetts Institute of Technology would be the right place for me to explore my interests in the area of Human Robot Interaction, and I would like to emphasise on the same for my doctoral studies. 
